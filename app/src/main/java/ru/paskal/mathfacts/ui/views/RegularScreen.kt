...
fun RegularScreen() {
    ...
    MainColumn {
        ...
        CardImpl(
            text = "166 is the number of athletes (104 men and 62 women) " +
                    "that represented Scotland in the 2006 Commonwealth " +
        ...
        // <--------------------------------------------------------------------------------------->
        Spacer(modifier = Modifier.padding(vertical = 8.dp))
        SavedListCard("166 is the number of athletes (104 men and 62 women)" +
                " that represented Scotland in the 2006 Commonwealth Games " +
